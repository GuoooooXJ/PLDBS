...
%arraryAlpha = [0	90	-90	180	90	180	0	-90]; % Random phase array
arraryAlpha = [90 -90	90	0	-90	180	0 180]; % Random phase array
...
%% Save data
filename = sprintf('Realtime_recording_Alpha_CyleByCycle_%d.mat', No);
