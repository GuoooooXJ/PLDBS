...
% STN beta: 0 180
%arraryBeta = [180	0	180	0	0	180	0	180]; % Random phase array
arraryBeta = [180	0	180	0 180 0]; % Random phase array
%arraryBeta = [-90	90	90	-90	-90	90	90	-90]; % Random phase array
%arraryBeta = [	90	-160 90	-160	-160	90]; % Random phase array
...
%% Save data
filename = sprintf('Realtime_recording_Beta_CyleByCycle_LongStim_%d.mat', No);
